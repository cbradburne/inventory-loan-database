...
"""
        ...
        self.checkBoxBkdO.setGeometry(QtCore.QRect(sgX*9, sgY*14, sgX*3, sgY*3))
        self.checkBoxBkdO.setStyleSheet("QCheckBox::indicator { margin-left:50%; margin-right:50%; border.color: #ff0000;}")
